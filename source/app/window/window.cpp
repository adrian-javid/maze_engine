...
int Window::windowWidth = 420;
int Window::windowHeight = 420;
std::function<void()> Window::windowRefresher = []() constexpr -> void {};

void Window::setRenderDrawColor(SDL_Color const &color) {
